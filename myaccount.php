  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto" style="padding-left:50%; ">
      ...
      <li class="nav-item" style=" ">
        <a class="nav-link" href="logout1.php" onclick="return confirm('Are you sure to logout?');">Logout</a>
      </li>
    
	</ul> 
    <b style="color:yellow;">User type:ADMIN</b>    
...
<main role="main" class="container" >
    <div class="jumbotron" style="text-align:center; ">
		...
		<h4>Welcome to Foodshala!!(ADMIN)<?php  
           
            if(isset($_SESSION['user_email'])){ echo $_SESSION['user_email'];
           
                  
                      echo '<br><button style="background-color:none; display:inline-block;"><a style="text-decoration:none;" href="addmenu.php">Click here to go ahead</a></button>';        
echo '<br><br>';
